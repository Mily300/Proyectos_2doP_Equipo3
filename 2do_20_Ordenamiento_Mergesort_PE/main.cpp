...
void ordenarEnteros() {
    ...
    mergeSortInt(punteros, 0, n - 1);
    
    cout << "\n[RESULTADO] Enteros ordenados: "; 
    for(int i = 0; i < n; i++) cout << *punteros[i] << " ";
    cout << endl;
...
void ordenarPersonasPE() {
    ...
    mergeSortPersona(punteros, 0, n - 1);

    cout << "\nResultados Ordenados (PE):" << endl;
    for (int i = 0; i < n; i++) {
...
int menu() {
    int opcion;
    system("cls");
    cout << "\nMenu Merge Sort Indirecto (PE)\n";
    cout << "\n1 - Ingresar y ordenar Enteros";
    cout << "\n2 - Ingresar y ordenar Caracteres";
    cout << "\n3 - Ingresar y ordenar Personas (Estructuras)";
    cout << "\n4 - Salir del menu\n";
...
int main() {
    ...
    for (int repeticion = 0; repeticion == 0; ) {
        ...
        switch (opcion) {
            case 1: ordenarEnteros(); 
				break;
            case 2: ordenarCaracteres(); 
				break;
            case 3: ordenarPersonasPE(); 
				break;
            case 4:
                cout << "\nHasta luego";
                repeticion++; 
